...
public class ShapeDraw extends JPanel {
     ...
     * drawing area. The controls include three buttons which are used to ass
    ...
    public ShapeDraw() {
        ...
        sizeChoice.addItem("1");
        sizeChoice.addItem("2");
        sizeChoice.addItem("3");
        sizeChoice.addItem("4");
    ...
    class DrawingArea extends JPanel
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            } else if (evt.getSource() == sizeChoice) {
